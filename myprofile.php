...
session_start();
        ...
        $sql=mysqli_query($db,"SELECT *from user_registration where id='".$_SESSION['id']."' LIMIT 1");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse  justify-content-end" id="Navbar">
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item active "><a class="nav-link" href="./myprofile.php"><span class="fa fa-user-circle"></span>My Account</a></li>
                    ...
                    <div class="card-body">
                        <form method="post" action="editprofile.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="firstname" name="firstname" required="requried" value="<?php echo $firstname;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lastname" class="col-md-2 col-form-label">Last Name</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="lastname" name="lastname" required="requried" placeholder="<?php echo $lastname;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="emailid" class="col-md-2 col-form-label">Current Email</label>
                                <div class="col-md-10">
                                    <input type="email" class="form-control" id="curremail" name="curremail" required="requried" placeholder="<?php echo $email; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="emailid" class="col-md-2 col-form-label">New Email</label>
                                <div class="col-md-10">
                                    <input type="email" class="form-control" id="email" name="email" required="requried" placeholder="New Email">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="telnum" name="telnum" required="requried" placeholder="<?php echo $telno;?>">
                                </div>
                            </div>
                            <div class="form-group row">
