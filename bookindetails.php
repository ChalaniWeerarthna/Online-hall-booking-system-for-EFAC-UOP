...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse  justify-content-end" id="Navbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="./bookindetails.php"><span class="fa fa-calendar"></span>View Booking Details</a></li>
    ...
    <header class="jumbotron">
        ...
        <div class="row row-header">
                <div class="col">
                    <h1 class="text-center"> View Booking details here</h1>
