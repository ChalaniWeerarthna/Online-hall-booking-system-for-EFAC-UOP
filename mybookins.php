                ...
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item active" href="./mybooking.php">Cancel Bookings</a>
                                </div>
    ...
    <div class="container"> 
        <div class="row">
            <ol class="col-12 breadcrumb">
                <li class="breadcrumb-item"><a href="./welcome.php">My bookings</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <?php include('errors.php'); ?>
                            ...
                            <div class="form-group row">
                                <label for="booking_id" class="col-md-2 col-form-label">Enter Username</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="username" name="username" required="required" placeholder="Username" value = "<?php echo $usernameC;?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="offset-md-2 col-md-10">
                                 <!--  <input class="btn btn-primary" type="button" value="Check">-->
                                    ...
                                    <button type="submit" name="cancelreserve2" class="btn btn-primary" role="button">Cancel Reservation</button>
